...
public class Lucene7AnsjAnalyzer extends Analyzer {
     ...
     * @param filter 停用词
     */
    public Lucene7AnsjAnalyzer(Map<String, String> args) {
        this.args = args;
    }

    public Lucene7AnsjAnalyzer(TYPE type, String dics) {
        this.args = new HashMap<String, String>();
        args.put("type", type.name());
        args.put(DicLibrary.DEFAULT, dics);
    }

    public Lucene7AnsjAnalyzer(TYPE type) {
        this.args = new HashMap<String, String>();
        args.put("type", type.name());
    }
    ...
    public static Tokenizer getTokenizer(Reader reader, Map<String, String> args) {
        ...
        if (type == null) {
            type = Lucene7AnsjAnalyzer.TYPE.base_ansj.name();
        }

        switch (Lucene7AnsjAnalyzer.TYPE.valueOf(type)) {
            case base_ansj:
