...
public class ManualPageProcessor extends LoggerBaseSupport implements PageProcessor, InitializingBean {
    ...
    @Autowired
    @Qualifier("manualIndexWriteService")
    ...
    public void process(Page page) {
        ...
        trs.forEach(tr -> {
            ...
            indexFileInfo.setUrl(detail_url);
        ...
        //添加终止文件，通知搜索引擎停止添加索引
        ManualIndexFileInfo endFile = new ManualIndexFileInfo();
        endFile.setId("end");
        indexService.addIndex(endFile);
    }
    ...
    protected void crawlerDetail(ManualIndexFileInfo indexFileInfo) {
        ...
        String detail_url = ManualConfig.domain + indexFileInfo.getUrl();
